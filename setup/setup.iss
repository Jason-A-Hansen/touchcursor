...
[Setup]
AppName=TouchCursor
AppVerName=TouchCursor 1.7.2
VersionInfoVersion=1.7.2.11
...
begin
  if CurStep = ssInstall then begin
    ...
    FileCopy(ExpandConstant('{userappdata}\TouchCursor\settings.cfg'), ExpandConstant('{userappdata}\TouchCursor\pre-1.7.2-settings.cfg'), True);
  end;
end;
